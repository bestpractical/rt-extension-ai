...
Set( %RT_AI_Provider,
      'Default' => {
         ...
         prompts => {
            ...
            generate_ticketsql => 'You are an expert in Request Tracker TicketSQL. Convert the natural language query into valid TicketSQL. Use the provided grammar reference to ensure correctness. Return ONLY the TicketSQL query without any explanation or markdown formatting.',
         },
